...
class Widget
{
  ...
  async render({_parentHeight, _parentWidth, ...inherited}={})
  {
    ...
    const renderContent = async () =>
    {
      ...
      const result = await this.renderContent({align, height, width, ...args})
    ...
    // Render
    let result = await renderContent()
    ...
    if(height == null || width == null)
    {
      ...
      if(reRender) result = await renderContent()
    }
